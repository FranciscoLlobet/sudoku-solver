...
/**
 * @brief Set the candidate mask of a cell
 * 
 * @param cell : Reference to Cell
 * @param mask : Bitmask
 */
...
/**
 * @brief Get the candidate mask of a cell
 * 
 * @param cell 
 * @return uint32_t 
 */
...
/**
 * @brief Convert Value to Bitmask
 * 
 * @param val 
 * @return uint32_t 
 */
static uint32_t getMaskFromValue(unsigned int val)
{
    return (1 << (val - 1));
}
